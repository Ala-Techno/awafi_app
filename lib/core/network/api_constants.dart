abstract class ApiConstants {
  ...
  // ═══════════════════════════════════════════════════════════════════
  //  ACTIVE CODE — FakeStore API (fakestoreapi.com)
  // ═══════════════════════════════════════════════════════════════════
  ...
  // ── Auth Endpoints ───────────────────────────────────────────────────────
  /// FakeStore accepts { username, password } — returns { token }
  static const String login = "auth/login";

  // ── Products Endpoints ───────────────────────────────────────────────────
  static const String products = "products";
  static const String categories = "products/categories";
  static const String productsByCategory = "products/category/"; // append category name

  // ── Cart Endpoints ───────────────────────────────────────────────────────
  static const String carts = "carts";
  static const String userCart = "carts/user/"; // append userId
  ...
  // ═══════════════════════════════════════════════════════════════════
  //  PRODUCTION SERVER — Real Backend (Commented)
  //  Uncomment and adjust when connecting to your production API.
  // ═══════════════════════════════════════════════════════════════════
